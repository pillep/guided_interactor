shared_examples :lint do
  ...
  describe '.new' do
    ...
    it 'initializes a context' do
      expect(GuidedInteractor::Context).to receive(:build).once.with(foo: 'bar') { context }
    ...
    it 'initializes a blank context if none is given' do
      expect(GuidedInteractor::Context).to receive(:build).once.with({}) { context }
  ...
  describe '#run' do
    ...
    it 'rescues failure' do
      expect(instance).to receive(:run!).and_raise(GuidedInteractor::Failure)
  ...
  describe '#run!' do
    ...
    it 'raises failure' do
      ...
      expect do
        instance.run!
      end.to raise_error(GuidedInteractor::Failure)
    end
